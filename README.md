...
| [02-posts-sharing](./02-posts-sharing) | Show how to decouple server side logic and client side data representation through either `REST` or `GraphQL` APIs | `Socket.io` `REST` `GraphQL` |
